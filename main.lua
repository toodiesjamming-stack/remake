...
-- Tier system removed; everyone treated as max tier so all features unlocked
getgenv()._aeroTierReady = true
getgenv().getAeroTier = function(player) return 99 end
getgenv().getAccountTier = function(player) return 99 end
